...
root = tk.Tk()
root.title("Nombre de la Empresa")
root.geometry("800x600")

# Crear el marco superior para el nombre de la empresa y la imagen del logo
frame_top = tk.Frame(root, relief=tk.RAISED, borderwidth=1)
...
frame_menu = tk.Frame(root, relief=tk.RAISED, borderwidth=1)
...
frame_sidebar = tk.Frame(root, relief=tk.RAISED, borderwidth=1)
...
frame_bottom = tk.Frame(root, relief=tk.RAISED, borderwidth=1)
